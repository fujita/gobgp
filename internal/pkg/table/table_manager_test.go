...
func TestProcessBGPUpdate_1_select_high_localpref_ipv6(t *testing.T) {
	...
	mpReach1, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC,
		[]bgp.AddrPrefixInterface{bgp.NewIPv6AddrPrefix(64, "2001:123:123:1::")}, netip.MustParseAddr("2001::192:168:50:1"))
	...
	mpReach2, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC,
		[]bgp.AddrPrefixInterface{bgp.NewIPv6AddrPrefix(64, "2001:123:123:1::")}, netip.MustParseAddr("2001::192:168:100:1"))
	med2 := bgp.NewPathAttributeMultiExitDisc(100)
	localpref2 := bgp.NewPathAttributeLocalPref(200)
...
func TestProcessBGPUpdate_2_select_local_origin_ipv6(t *testing.T) {
	...
	aspath2 := createAsPathAttribute([]uint32{})
	mpReach2, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC,
		[]bgp.AddrPrefixInterface{bgp.NewIPv6AddrPrefix(64, "2001:123:123:1::")}, netip.MustParseAddr("::"))
	med2 := bgp.NewPathAttributeMultiExitDisc(100)
	localpref2 := bgp.NewPathAttributeLocalPref(100)
...
func TestProcessBGPUpdate_multiple_nlri_ipv6(t *testing.T) {
	...
	checkPattr := func(expected *bgp.BGPMessage, actual *Path) {
		...
		expectedNexthopAttr, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC,
			[]bgp.AddrPrefixInterface{actual.GetNlri()}, bgpUpdateNexthop.(*bgp.PathAttributeMpReachNLRI).Nexthop)
		attr := actual.getPathAttr(bgp.BGP_ATTR_TYPE_MP_REACH_NLRI)
		pathNexthop := attr.(*bgp.PathAttributeMpReachNLRI)
		assert.Equal(t, expectedNexthopAttr, pathNexthop)
	...
	mpreach1, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC,
		[]bgp.AddrPrefixInterface{bgp.NewIPv6AddrPrefix(64, "2001:123:1210:11::"),
	...
	mpreach2, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC,
		[]bgp.AddrPrefixInterface{bgp.NewIPv6AddrPrefix(64, "2001:123:1211:11::"),
	...
	mpreach3, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC,
		[]bgp.AddrPrefixInterface{bgp.NewIPv6AddrPrefix(64, "2001:123:1277:11::"),
			bgp.NewIPv6AddrPrefix(64, "2001:123:1288:11::")}, netip.MustParseAddr("2001::192:168:50:1"))
...
func TestProcessBGPUpdate_multiple_nlri_ipv4_split(t *testing.T) {
	...
	mpReach, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv4_UC,
		[]bgp.AddrPrefixInterface{bgp.NewIPAddrPrefix(32, "10.0.0.1"),
			bgp.NewIPAddrPrefix(32, "10.0.0.2"),
			bgp.NewIPAddrPrefix(32, "10.0.0.3")}, netip.MustParseAddr("10.50.60.70"))
...
func update_fromR2_ipv6() *bgp.BGPMessage {
	...
	mpReach, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC, []bgp.AddrPrefixInterface{
		bgp.NewIPv6AddrPrefix(64, "2002:223:123:1::")}, netip.MustParseAddr("2001::192:168:100:1"))
	med := bgp.NewPathAttributeMultiExitDisc(100)
...
func update_fromR2viaR1_ipv6() *bgp.BGPMessage {
	...
	mpReach, _ := bgp.NewPathAttributeMpReachNLRI(bgp.RF_IPv6_UC, []bgp.AddrPrefixInterface{
		bgp.NewIPv6AddrPrefix(64, "2002:223:123:1::")}, netip.MustParseAddr("2001::192:168:50:1"))
	med := bgp.NewPathAttributeMultiExitDisc(100)
