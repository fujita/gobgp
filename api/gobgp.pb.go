...
const (
	// peer state
	MonitorEventType_PEER MonitorEventType = 0
	// update message
	MonitorEventType_PATH MonitorEventType = 1
)

var MonitorEventType_name = map[int32]string{
	0: "PEER",
	1: "PATH",
}
var MonitorEventType_value = map[string]int32{
	"PEER": 0,
	"PATH": 1,
}

func (x MonitorEventType) String() string {
	return proto.EnumName(MonitorEventType_name, int32(x))
}
func (MonitorEventType) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{9} }
...
type MonitorEventRequest struct {
	EventType []MonitorEventType `protobuf:"varint,1,rep,packed,name=event_type,json=eventType,enum=gobgpapi.MonitorEventType" json:"event_type,omitempty"`
}

func (m *MonitorEventRequest) Reset()                    { *m = MonitorEventRequest{} }
func (m *MonitorEventRequest) String() string            { return proto.CompactTextString(m) }
func (*MonitorEventRequest) ProtoMessage()               {}
func (*MonitorEventRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{142} }

func (m *MonitorEventRequest) GetEventType() []MonitorEventType {
	if m != nil {
		return m.EventType
	}
	return nil
...
type MonitorEventResponse struct {
	EventType MonitorEventType `protobuf:"varint,1,opt,name=event_type,json=eventType,enum=gobgpapi.MonitorEventType" json:"event_type,omitempty"`
	Peer      *Peer            `protobuf:"bytes,2,opt,name=peer" json:"peer,omitempty"`
	Path      []*Path          `protobuf:"bytes,3,rep,name=path" json:"path,omitempty"`
}

func (m *MonitorEventResponse) Reset()                    { *m = MonitorEventResponse{} }
func (m *MonitorEventResponse) String() string            { return proto.CompactTextString(m) }
func (*MonitorEventResponse) ProtoMessage()               {}
func (*MonitorEventResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{143} }

func (m *MonitorEventResponse) GetEventType() MonitorEventType {
	if m != nil {
		return m.EventType
	}
	return MonitorEventType_PEER
}

func (m *MonitorEventResponse) GetPeer() *Peer {
	if m != nil {
		return m.Peer
	}
	return nil
...
func (m *MonitorEventResponse) GetPath() []*Path {
	if m != nil {
		return m.Path
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MonitorEventRequest)(nil), "gobgpapi.MonitorEventRequest")
	proto.RegisterType((*MonitorEventResponse)(nil), "gobgpapi.MonitorEventResponse")
	...
	proto.RegisterEnum("gobgpapi.MonitorEventType", MonitorEventType_name, MonitorEventType_value)
...
type GobgpApiClient interface {
	...
	MonitorEvent(ctx context.Context, in *MonitorEventRequest, opts ...grpc.CallOption) (GobgpApi_MonitorEventClient, error)
}
...
func (c *gobgpApiClient) MonitorEvent(ctx context.Context, in *MonitorEventRequest, opts ...grpc.CallOption) (GobgpApi_MonitorEventClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_GobgpApi_serviceDesc.Streams[12], c.cc, "/gobgpapi.GobgpApi/MonitorEvent", opts...)
	if err != nil {
		return nil, err
	}
	x := &gobgpApiMonitorEventClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type GobgpApi_MonitorEventClient interface {
	Recv() (*MonitorEventResponse, error)
	grpc.ClientStream
}

type gobgpApiMonitorEventClient struct {
	grpc.ClientStream
}

func (x *gobgpApiMonitorEventClient) Recv() (*MonitorEventResponse, error) {
	m := new(MonitorEventResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GobgpApiServer interface {
	...
	MonitorEvent(*MonitorEventRequest, GobgpApi_MonitorEventServer) error
}
...
func _GobgpApi_MonitorEvent_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(MonitorEventRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GobgpApiServer).MonitorEvent(m, &gobgpApiMonitorEventServer{stream})
}

type GobgpApi_MonitorEventServer interface {
	Send(*MonitorEventResponse) error
	grpc.ServerStream
}

type gobgpApiMonitorEventServer struct {
	grpc.ServerStream
}

func (x *gobgpApiMonitorEventServer) Send(m *MonitorEventResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _GobgpApi_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _GobgpApi_MonitorEvent_Handler,
			ServerStreams: true,
		},
	},
...
var fileDescriptor2 = []byte{
	...
	,
}
