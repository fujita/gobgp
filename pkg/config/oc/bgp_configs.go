...
const (
	...
	BFD_DIAGNOSTIC_CODE_FORWARDING_RESET               BfdDiagnosticCode = "forwarding_reset"
	...
	BFD_DIAGNOSTIC_CODE_ADMIN_DOWN                     BfdDiagnosticCode = "admin_down"
	BFD_DIAGNOSTIC_CODE_REVERSE_CONCATENATED_PATH_DOWN BfdDiagnosticCode = "reverse_concatenated_path_down"
	BFD_DIAGNOSTIC_CODE_NEIGHBOR_DOWN                  BfdDiagnosticCode = "neighbor_down"
)
...
var BfdDiagnosticCodeToIntMap = map[BfdDiagnosticCode]int{
	...
	BFD_DIAGNOSTIC_CODE_FORWARDING_RESET:               3,
	BFD_DIAGNOSTIC_CODE_PATH_DOWN:                      4,
	BFD_DIAGNOSTIC_CODE_CONCATENATED_PATH_DOWN:         5,
	BFD_DIAGNOSTIC_CODE_ADMIN_DOWN:                     6,
	BFD_DIAGNOSTIC_CODE_REVERSE_CONCATENATED_PATH_DOWN: 7,
	BFD_DIAGNOSTIC_CODE_NEIGHBOR_DOWN:                  8,
}
...
var IntToBfdDiagnosticCodeMap = map[int]BfdDiagnosticCode{
	...
	3: BFD_DIAGNOSTIC_CODE_FORWARDING_RESET,
	4: BFD_DIAGNOSTIC_CODE_PATH_DOWN,
	5: BFD_DIAGNOSTIC_CODE_CONCATENATED_PATH_DOWN,
	6: BFD_DIAGNOSTIC_CODE_ADMIN_DOWN,
	7: BFD_DIAGNOSTIC_CODE_REVERSE_CONCATENATED_PATH_DOWN,
	8: BFD_DIAGNOSTIC_CODE_NEIGHBOR_DOWN,
}
...
type BfdState struct {
	...
	LocalDiscriminator string `mapstructure:"local-discriminator" json:"local-discriminator,omitempty"`
	// original -> gobgp:remote-discriminator
	// Discriminator received from the remote system.
	RemoteDiscriminator string `mapstructure:"remote-discriminator" json:"remote-discriminator,omitempty"`
