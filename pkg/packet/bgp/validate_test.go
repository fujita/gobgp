...
func bgpupdate() *BGPMessage {
	...
	return NewBGPUpdateMessage(nil, p, []PathNLRI{PathNLRI{NLRI: n[0]}})
}
...
func bgpupdateV6() *BGPMessage {
	...
	mpreach, _ := NewPathAttributeMpReachNLRI(RF_IPv6_UC, []PathNLRI{PathNLRI{NLRI: prefixes[0]}}, netip.MustParseAddr("1023::"))
	p = append(p, mpreach)
...
func Test_Validate_flowspec(t *testing.T) {
	...
	a, _ := NewPathAttributeMpReachNLRI(RF_FS_IPv4_UC, []PathNLRI{PathNLRI{NLRI: n1}}, netip.IPv4Unspecified())
